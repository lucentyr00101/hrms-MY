export default {
  ...
  'dashboard.analysis.status.timein': 'Time In',
  ...
  'dashboard.analysis.action.work-reports': 'Work Reports',
  ...
  'dashboard.analysis.status.start-break': 'Start Break',
  'dashboard.analysis.status.end-break': 'End Break'
}
