...
if (process.env.NODE_ENV !== 'production' || process.env.VUE_APP_PREVIEW === 'true') {
  ...
  require('./services/dictionary-type')
  require('./services/dictionary-values')
  require('./services/assets')
  require('./services/attendance-lists')
  require('./services/department')
  require('./services/employee')
  require('./services/banks')
  require('./services/employee-assets')
  require('./services/deductions')
