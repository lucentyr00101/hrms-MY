...
export default {
  name: 'InterviewInterviewListScheduledInterview',
  data() {
    return {
      selectedItems: [],
      queryParam: {},
      ...
      loadData: async (parameter) => {
        ...
        const response = await this.$store.dispatch('api/interview/interview/fetchList', { config: { list: 'scheduledList' }, params })
